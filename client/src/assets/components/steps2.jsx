          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25 thq-body-small">
                      Explore a wide range of movies across various genres.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28 thq-body-small">
                      Save your favorite movies to watch later at your
                      convenience.
                    </span>
                  </Fragment>
                )}
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26 thq-body-small">
                      Enjoy high-definition streaming for an immersive viewing
                      experience.
                    </span>
                  </Fragment>
                )}
            ...
            <div className="steps2-container7 thq-card">
              <h2>
                {props.step4Title ?? (
                  <Fragment>
                    <h2 className="steps2-text35 thq-heading-2">
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text31 thq-body-small">
                      <span>
                        Get movie suggestions tailored to your preferences based
