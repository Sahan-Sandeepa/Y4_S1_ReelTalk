...
Steps.defaultProps = {
  step1Description:
    'Create an account on our movie application to access all features.',
  step3Description:
    'Stay connected with your family members through our secure messaging feature.',
  step2Title: 'Browse Movies',
  step2Description:
    'Explore a wide range of movies suitable for the whole family.',
  step1Title: 'Sign Up',
  step3Title: 'Family Messaging',
  step4Description:
    'Sit back, relax, and enjoy watching movies together with your loved ones.',
  step4Title: 'Enjoy Watching',
}
